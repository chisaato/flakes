...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src =
    let
      ...
      hash = selectSystem {
        x86_64-linux = "sha256-2/fDZeqesX9UMdNfLN5oo5kl6IO5zz2eDfTRzZqMnSI=";
    ...
    in
    fetchurl {
      url = "https://c.scgit.top/dbeaver.com/files/${finalAttrs.version}/dbeaver-ue-${finalAttrs.version}-${suffix}";
      inherit hash;
    };
