...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src =
    let
      ...
      hash = selectSystem {
        x86_64-linux = "sha256-MHMLQjbJS283anuXJM22eHVfXd5rD3npkGowcuKo9xY=";
    ...
    in
    fetchurl {
      url = "https://downloads.dbeaver.net/team/${finalAttrs.version}/dbeaver-te-${finalAttrs.version}-${suffix}";
      inherit hash;
    };
    ...
    if !stdenvNoCC.hostPlatform.isDarwin then
      ''
        ...
        substituteInPlace $out/opt/dbeaver-te/dbeaver-te.desktop \
          ...
          --replace-fail "/usr/share/dbeaver-te/dbeaver" "$out/bin/dbeaver-te"
